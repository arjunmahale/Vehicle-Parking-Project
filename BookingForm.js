...
class Entry{
    constructor(owner,car,carmodel,carcolor,licensePlate){
        this.owner = owner;
        this.car = car;
        this.car = carmodel;
        this.car = carcolor;
...
//UI Class: Handle User Interface Tasks
    ...
    static validateInputs(){
        ...
        if(owner === '' || car === '' || carmodel === '' || carcolor === '' || licensePlate === ''){
...
//Event Add
    document.querySelector('#entryForm').addEventListener('submit',(e)=>{
        ...
        //Instatiate Entry
        const entry = new Entry(owner, car, carmodel, carcolor, licensePlate);
